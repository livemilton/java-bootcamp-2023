...
import ExtraPractice3.Contact;
import ExtraPractice3.ContactManager;
...
public class Main {
    ...
    public static Contact[] contactData() {
        return new Contact[] {
                new Contact("Jhon Doe", "555-123-4567", "1985-01-01"),
                ...
                new Contact("Charlie Davis", "555-111-22220", "1983-07-04"),
